...
#Path where videos to analyze will reside
novel_videos = ['/gpfs/home/acp18/Projects/SC25_BW-DewanLab-2021-09-01/videos/Novel_Videos/BW_5.mp4']
...
#NovelVideo
deeplabcut.analyze_videos(config_path, novel_videos, shuffle=1, save_as_csv=True, videotype='.mp4') 

deeplabcut.plot_trajectories(config_path, novel_videos, videotype=".mp4")

deeplabcut.create_labeled_video(config_path, novel_videos, videotype=".mp4")
